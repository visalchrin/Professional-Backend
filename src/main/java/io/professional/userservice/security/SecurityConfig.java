...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().antMatchers("/api/login/**", "/api/register/**", "/api/token/refresh/**").permitAll();
        // http.authorizeHttpRequests().antMatchers("/api/users/**").permitAll(); // permit all work for /users
        // http.authorizeHttpRequests().antMatchers("/api/post/**").permitAll();
